/**
 * System prompt for the lesson generator.
 *
 * Canonical copy used by the /api/admin/generate-lesson route
 * (iPad-friendly browser workflow).
 *
 * A human-readable copy of the same prompt also lives at
 * scripts/prompts/generate-lesson-system.md for the CLI-based
 * workflow (scripts/generate-lesson.mjs). When updating the prompt,
 * update BOTH files to keep them in sync.
 */
export const GENERATE_LESSON_SYSTEM_PROMPT = `# Mathly Lesson Generator — System Prompt
